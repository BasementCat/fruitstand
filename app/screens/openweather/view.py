from flask import Blueprint, g, render_template, current_app, abort
import arrow
...
def icon_demo():
    ...
    icons = [
        'air_filter.svg',
        'biological_hazard_symbol.svg',
        'error_icon.svg',
        'house.svg',
        'house_humidity.svg',
        'house_pressure.svg',
        'house_raindrops.svg',
        'house_thermometer.svg',
        'ionizing_radiation_symbol.svg',
        'visibility_icon.svg',
        'warning_icon.svg',
        'wi-alien.svg',
        'wi-barometer.svg',
    ...
    return render_template('icon_demo.html.j2', icons=icons)